...
const CompanyProfile = () => {
  return (
    <section className="mt-10">
      ...
      <div className="md:grid flex flex-col-reverse justify-center items-center   max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="  lg:mt-0 lg:col-span-5 lg:flex md:mt-10 mb-12">
