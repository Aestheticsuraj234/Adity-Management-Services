      ...
      <motion.div
        ...
        <motion.div
          ...
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: false, amount: 0.25 }}
            className="max-w-2xl font-normal text-gray-500 lg:mb-8 md:text-lg lg:text-base  ">Join us in creating safe and elegant spaces. Adity Management Services Pvt Ltd - where safety meets style, and where perfection is our promise.</motion.p>
        </motion.div>
