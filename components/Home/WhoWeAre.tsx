...
const WhoWeAre = () => {
    return (
        <div className='flex flex-col items-center justify-center text-center mt-10 mb-6'>
            <h1 className='text-4xl font-extrabold text-[#666DD4] py-4 '>Who We Are</h1>
            <svg xmlns="http://www.w3.org/2000/svg" width="226" height="12" viewBox="0 0 326 12" fill="none">
                <path d="M6.04779 6.00018H320.054" stroke="#666DD4" stroke-width="11" stroke-linecap="round" />
            </svg>
            <p className='font-bold text-zinc-600 text-2xl mt-4 '>
